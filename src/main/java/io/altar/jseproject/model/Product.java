...
public class Product extends myEntity {
	...
	public Product(double descontoUni, double iva, double pvp) {
		// this.id = contadorIds++; // faz mais sentido q eu crie os ids p serem gerados
		// automaticamente c um incremento do q me lembrar de atribuir um id manualmente
		this.descontoUni = descontoUni;
		this.iva = iva;
		this.pvp = pvp;
		this.prateleiras = new ArrayList<>(); // <> chamam se generics e sao usados p especificar o tipo de elementos q
												// vao estar dentro da lista
	}
	...
	public void setPrateleiras(List<Long> prateleiras) { // substitui a lista de prateleiras atual por uma nova lista
		this.prateleiras = prateleiras; // isto serve p caso eu queira remover um produto do sistema limpar as
										// prateleiras onde ele estava
	}

	// public int getId() { // acesso o valor do atributo ido fora da class e
	// retorna me o valor atual do atributo
	// return id;
	// }
